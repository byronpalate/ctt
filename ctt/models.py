...
from django.db.models import F, PROTECT, Prefetch
...
from settings import CLASES_HORARIO_ESTRICTO, CLASES_APERTURA_ANTES, CLASES_APERTURA_DESPUES, ARCHIVO_TIPO_SYLLABUS, \
    ...
    UTILIZA_VALIDACION_CALIFICACIONES, CLASES_CIERRE_ANTES, GENERAR_RUBRO_MORA_CUOTA, \
    ...
    RUBRO_OTRO_ARANCEL_ID, \
    RUBRO_OTRO_MATRICULA_ID, RUBRO_OTRO_OTROS_EDUCATIVOS_ID, RUBRO_OTRO_DERECHOS_ESPECIES_ID, \
    RUBRO_OTRO_CURSOS_LIBRE_CONFIGURACION_ID, RUBRO_OTRO_SOLICITUD_ID, \
    TIEMPO_PRORROGA_UNO, TIEMPO_PRORROGA_DOS, TIEMPO_ACTUALIZAON_CONOCIMIENTO, UTILIZA_GRATUIDADES, MODELO_NIVELACION, TIPO_PERIODO_POSGRADO, TIPO_PERIODO_GRADO, RAZA_ID, \
    TERCER_NIVEL_TITULACION_ID, CUARTO_NIVEL_TITULACION_ID, \
    ...
    PROVEEDOR_PAGOONLINE_PAYPHONE, \
    OTROS_BANCOS_EXTERNOS_ID, PROVEEDOR_PAGOONLINE_DATAFAST, TIPO_IVA_15_ID, APP_DOMAIN, FORMA_PAGO_TARJETA, \
    PERFIL_CLIENTE_ID
...
class Perms(models.Model):
    class Meta:
        permissions = (
            ...
            ("puede_abrir_materia", "Abrir materia"),
            ("puede_abrir_matriculas_materias", "Abrir matriculas materias"),
            ("puede_anular_matriculas", "Anular matriculas"),
            ("puede_aprobar_contrato_docente", "Aprobar contrato docente"),
            ("puede_aprobar_criterios_decano", "Aprobar criterios decano"),
            ("puede_aprobar_distributivo", "Aprobar distributivo"),
            ("puede_aprobarubro_cursos", "Aprobar rubro cursos"),
            ("puede_autorizar_cobros_parciales", "Autorizar cobros parciales"),
            ("puede_autorizar_matricula_deuda", "Autorizar matricula con deuda"),
            ("puede_bloquear_distributivos", "Bloquear distributivos"),
            ("puede_bloquear_distributivos_2", "Bloquear distributivos 2"),
            ("puede_eliminar_calificaciones_materia", "Eliminar calificaciones materia"),
            ("puede_eliminar_matriculas", "Eliminar matriculas"),
            ("puede_formalizar_matricula", "Formalizar matricula"),
            ("puede_generar_rubros_completo_posgrado", "Generar rubros completo posgrado"),
            ("puede_habilitar_inscripcion_para_matricula", "Habilitar inscripcion para matricula"),
            ("puede_importar_inscripciones", "Importar inscripciones"),
            ("puede_ingresar_contrato_docente", "Ingresar contrato docente"),
            ("puede_matricular", "Matricular"),
            ("puede_modificar_administrativos", "Modificar administrativos"),
            ("puede_modificar_asignaturas", "Modificar asignaturas"),
            ("puede_modificar_asistenciamateriaasignada", "Modificar asistencia materia asignada"),
            ("puede_modificar_aula_horario", "Modificar aula horario"),
            ("puede_modificar_calificacion_tardia", "Modificar calificacion tardia"),
            ("puede_modificar_cupo_materias", "Modificar cupo materias"),
            ("puede_modificar_datos_financieros", "Modificar datos financieros"),
            ("puede_modificar_egresado", "Modificar egresado"),
            ("puede_modificar_informacion_academica_restringida", "Modificar informacion academica restringida"),
            ("puede_modificar_inscripciones", "Modificar inscripciones"),
            ("puede_modificar_materias", "Modificar materias"),
            ("puede_modificar_matriculas", "Modificar matriculas"),
            ("puede_modificar_modelo_evaluativo_materia", "Modificar modelo evaluativo materia"),
            ("puede_modificar_modelos_evaluativos", "Modificar modelos evaluativos"),
            ("puede_modificar_parametros_institucion", "Modificar parametros institucion"),
            ("puede_modificar_precioperiodo", "Modificar precio periodo"),
            ("puede_modificar_profesor_materia", "Modificar profesor materia"),
            ("puede_modificar_profesores", "Modificar profesores"),
            ("puede_modificar_records", "Modificar records"),
            ("puede_modificar_salario_docente", "Modificar salario docente"),
            ("puede_registar_solicitudes", "Registrar solicitudes"),
            ("puede_ver_informacion_inscritos", "Ver informacion inscritos")
        )
