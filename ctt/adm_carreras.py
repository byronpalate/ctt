...
from ctt.forms import CarreraForm, CompetenciaEspecificaForm, TituloForm, TituloCarreraForm
from ctt.funciones import MiPaginador, log, ok_json, bad_json, url_back, remover_tildes
from ctt.models import Carrera, CompetenciaEspecifica, TituloObtenido, TituloObtenidoCarrera
